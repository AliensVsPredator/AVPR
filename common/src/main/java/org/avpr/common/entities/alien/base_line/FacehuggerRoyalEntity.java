...
public class FacehuggerRoyalEntity extends AlienEntity implements SmartBrainOwner<FacehuggerRoyalEntity> {

    public static final EntityDataAccessor<Boolean> EGGSPAWN = SynchedEntityData.defineId(
        FacehuggerRoyalEntity.class,
    ...
    public FacehuggerRoyalEntity(EntityType<? extends AlienEntity> entityType, Level level) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes()
            .add(Attributes.MAX_HEALTH, CommonMod.config.facehuggerRoyalConfigs.FACEHUGGER_ROYAL_HEALTH)
            .add(
                Attributes.ARMOR,
                1.0
            )
            ...
            .add(Attributes.MOVEMENT_SPEED, CommonMod.config.facehuggerRoyalConfigs.FACEHUGGER_QUEEN_SPEED);
    }
    ...
    public void handleAttachmentToHost() {
        if (isAttachedToHost()) {
            ...
            if (ticksAttachedToHost > CommonMod.config.facehuggerRoyalConfigs.FACEHUGGER_ROYAL_ATTACH_TIME_IN_TICKS) {
                ...
                if (!livingEntity.hasEffect(AVPRStatusEffects.IMPREGNATION))
                    livingEntity.addEffect(
                        new MobEffectInstance(
                            ...
                            CommonMod.config.facehuggerRoyalConfigs.FACEHUGGER_ROYAL_IMPREG_TIMER,
                            0,
                            false,
                            true
                        )
    ...
    public void grabTarget(LivingEntity entity) {
        ...
        if (CommonMod.config.facehuggerRoyalConfigs.FACEHUGGER_ROYAL_GIVE_BLINDNESS)
            entity.addEffect(
                new MobEffectInstance(
                    MobEffects.BLINDNESS,
                    (int) CommonMod.config.facehuggerRoyalConfigs.FACEHUGGER_ROYAL_ATTACH_TIME_IN_TICKS,
                    0
                )
            );
    ...
    @Override
    public List<ExtendedSensor<FacehuggerRoyalEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<FacehuggerRoyalEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<FacehuggerRoyalEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<FacehuggerRoyalEntity> getIdleTasks() {
        return BrainActivityGroup.idleTasks(
            new FirstApplicableBehaviour<FacehuggerRoyalEntity>(
    ...
    @Override
    public BrainActivityGroup<FacehuggerRoyalEntity> getFightTasks() {
