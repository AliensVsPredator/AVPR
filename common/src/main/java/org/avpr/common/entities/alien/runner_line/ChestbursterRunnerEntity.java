package org.avpr.common.entities.alien.runner_line;
...
public class ChestbursterRunnerEntity extends AlienEntity implements SmartBrainOwner<ChestbursterRunnerEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public ChestbursterRunnerEntity(EntityType<? extends AlienEntity> entityType, Level level) {
    ...
    public LivingEntity growInto() {
        return AVPREntities.DRONE_RUNNER.get().create(level());
    }
    ...
    @Override
    public List<? extends ExtendedSensor<ChestbursterRunnerEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<ChestbursterRunnerEntity>().setPredicate(
            ...
            new NearbyBlocksSensor<ChestbursterRunnerEntity>().setRadius(7)
                .setPredicate(
                    (block, entity) -> block.is(AVPRBlockTags.ALIEN_REPELLENTS)
                ),
            new NearbyItemsSensor<ChestbursterRunnerEntity>().setRadius(7)
                .setPredicate(
    ...
    @Override
    public BrainActivityGroup<ChestbursterRunnerEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<ChestbursterRunnerEntity> getFightTasks() {
