...
public class NauticomorphEntity extends AlienEntity implements SmartBrainOwner<NauticomorphEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public NauticomorphEntity(EntityType<? extends AlienEntity> entityType, Level level) {
        super(entityType, level);
        spawnPos = CommonMod.config.nauticomorphConfigs.NAUTICOMORPH_MIN_SPAWN_Y;
    }
    ...
    @Override
    public List<? extends ExtendedSensor<NauticomorphEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<NauticomorphEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<NauticomorphEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<NauticomorphEntity> getFightTasks() {
