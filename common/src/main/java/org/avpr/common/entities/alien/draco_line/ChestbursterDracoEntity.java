...
public class ChestbursterDracoEntity extends AlienEntity implements SmartBrainOwner<ChestbursterDracoEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public ChestbursterDracoEntity(EntityType<? extends AlienEntity> entityType, Level level) {
    ...
    public LivingEntity growInto() {
        return AVPREntities.DRACOMORPH.get().create(level());
    }
    ...
    @Override
    public List<? extends ExtendedSensor<ChestbursterDracoEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<ChestbursterDracoEntity>().setPredicate(
            ...
            new NearbyItemsSensor<ChestbursterDracoEntity>().setRadius(7)
                .setPredicate(
    ...
    @Override
    public BrainActivityGroup<ChestbursterDracoEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<ChestbursterDracoEntity> getFightTasks() {
