...
public class OctohuggerEntity extends AlienEntity implements SmartBrainOwner<OctohuggerEntity> {

    public static final EntityDataAccessor<Boolean> EGGSPAWN = SynchedEntityData.defineId(
        OctohuggerEntity.class,
    ...
    public OctohuggerEntity(EntityType<? extends AlienEntity> entityType, Level level) {
    ...
    @Override
    public List<ExtendedSensor<OctohuggerEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<OctohuggerEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<OctohuggerEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<OctohuggerEntity> getIdleTasks() {
        return BrainActivityGroup.idleTasks(
            new FirstApplicableBehaviour<OctohuggerEntity>(
    ...
    @Override
    public BrainActivityGroup<OctohuggerEntity> getFightTasks() {
