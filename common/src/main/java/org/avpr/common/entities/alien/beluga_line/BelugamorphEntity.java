...
public class BelugamorphEntity extends AlienEntity implements SmartBrainOwner<BelugamorphEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public BelugamorphEntity(EntityType<? extends AlienEntity> entityType, Level level) {
    ...
    @Override
    public List<? extends ExtendedSensor<BelugamorphEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<BelugamorphEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<BelugamorphEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<BelugamorphEntity> getIdleTasks() {
    ...
    @Override
    public BrainActivityGroup<BelugamorphEntity> getFightTasks() {
