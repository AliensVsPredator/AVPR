...
public class DracomorphEntity extends AlienEntity implements SmartBrainOwner<DracomorphEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public DracomorphEntity(EntityType<? extends AlienEntity> entityType, Level level) {
    ...
    @Override
    public List<? extends ExtendedSensor<DracomorphEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<DracomorphEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<DracomorphEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<DracomorphEntity> getFightTasks() {
