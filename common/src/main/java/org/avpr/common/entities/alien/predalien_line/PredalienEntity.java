package org.avpr.common.entities.alien.predalien_line;
...
public class PredalienEntity extends AlienEntity implements SmartBrainOwner<PredalienEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public PredalienEntity(EntityType<? extends AlienEntity> entityType, Level level) {
    ...
    @Override
    public List<? extends ExtendedSensor<PredalienEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<PredalienEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<PredalienEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<PredalienEntity> getFightTasks() {
