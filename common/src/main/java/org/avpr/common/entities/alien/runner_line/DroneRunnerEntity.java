...
public class DroneRunnerEntity extends AlienEntity implements SmartBrainOwner<DroneRunnerEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public DroneRunnerEntity(EntityType<? extends AlienEntity> entityType, Level level) {
        super(entityType, level);
        spawnPosMax = CommonMod.config.droneRunnerConfigs.DRONERUNNER_MAX_SPAWN_Y;
        spawnPosMin = CommonMod.config.droneRunnerConfigs.DRONERUNNER_MIN_SPAWN_Y;
    }
    ...
    public LivingEntity growInto() {
        return AVPREntities.WARRIOR_RUNNER.get().create(level());
    }
    ...
    @Override
    public List<? extends ExtendedSensor<DroneRunnerEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<DroneRunnerEntity>().setPredicate(
            ...
            new NearbyBlocksSensor<DroneRunnerEntity>().setRadius(7)
                .setPredicate(
    ...
    @Override
    public BrainActivityGroup<DroneRunnerEntity> getCoreTasks() {
