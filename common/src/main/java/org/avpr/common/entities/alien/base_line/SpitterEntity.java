...
public class SpitterEntity extends AlienEntity implements SmartBrainOwner<SpitterEntity> {
    ...
    public SpitterEntity(EntityType<? extends AlienEntity> entityType, Level level) {
        ...
        spawnPosMax = CommonMod.config.spitterConfigs.SPITTER_MAX_SPAWN_Y;
    }

    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes()
            .add(Attributes.ATTACK_DAMAGE, CommonMod.config.spitterConfigs.SPITTER_ATTACK)
            .add(Attributes.MAX_HEALTH, CommonMod.config.spitterConfigs.SPITTER_HEALTH)
            .add(Attributes.MOVEMENT_SPEED, CommonMod.config.spitterConfigs.SPITTER_SPEED);
    }
    ...
    @Override
    public List<? extends ExtendedSensor<SpitterEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<SpitterEntity>().setPredicate(
