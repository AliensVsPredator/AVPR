...
public class ChestbursterQueenEntity extends AlienEntity implements SmartBrainOwner<ChestbursterQueenEntity> {
    ...
    public LivingEntity growInto() {
        return AVPREntities.QUEEN.get().create(level());
    }
    ...
    @Override
    public List<ExtendedSensor<ChestbursterQueenEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<ChestbursterQueenEntity>().setPredicate(
            ...
            new NearbyBlocksSensor<ChestbursterQueenEntity>().setRadius(7)
                .setPredicate(
                    (block, entity) -> block.is(AVPRBlockTags.ALIEN_REPELLENTS)
                ),
            new NearbyItemsSensor<ChestbursterQueenEntity>().setRadius(7)
                .setPredicate(
    ...
    @Override
    public BrainActivityGroup<ChestbursterQueenEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<ChestbursterQueenEntity> getIdleTasks() {
    ...
    @Override
    public BrainActivityGroup<ChestbursterQueenEntity> getFightTasks() {
