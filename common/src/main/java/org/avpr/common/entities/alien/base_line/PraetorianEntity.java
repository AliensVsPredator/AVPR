...
public class PraetorianEntity extends AlienEntity implements SmartBrainOwner<PraetorianEntity> {
    ...
    @Override
    public List<? extends ExtendedSensor<PraetorianEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<PraetorianEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<PraetorianEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<PraetorianEntity> getFightTasks() {
