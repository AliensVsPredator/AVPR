...
public class WarriorEntity extends AlienEntity implements SmartBrainOwner<WarriorEntity> {
    ...
    @Override
    public List<? extends ExtendedSensor<WarriorEntity>> getSensors() {
        return ObjectArrayList.of(
            ...
            new NearbyBlocksSensor<WarriorEntity>().setRadius(7)
                .setPredicate(
