...
public class DeaconAdultEngineerEntity extends AlienEntity implements SmartBrainOwner<DeaconAdultEngineerEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public DeaconAdultEngineerEntity(EntityType<? extends AlienEntity> entityType, Level level) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes()
            ...
            .add(Attributes.MAX_HEALTH, CommonMod.config.deaconAdultEngineer.damage)
    ...
    @Override
    public List<? extends ExtendedSensor<DeaconAdultEngineerEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<DeaconAdultEngineerEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<DeaconAdultEngineerEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<DeaconAdultEngineerEntity> getIdleTasks() {
