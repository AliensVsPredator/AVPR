...
public class DeaconAdultEntity extends AlienEntity implements SmartBrainOwner<DeaconAdultEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public DeaconAdultEntity(EntityType<? extends AlienEntity> entityType, Level level) {
    ...
    @Override
    public List<? extends ExtendedSensor<DeaconAdultEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<DeaconAdultEntity>().setPredicate(
            ...
            new NearbyBlocksSensor<DeaconAdultEntity>().setRadius(7)
                .setPredicate(
    ...
    @Override
    public BrainActivityGroup<DeaconAdultEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<DeaconAdultEntity> getFightTasks() {
