...
public class TriolobiteEntity extends AlienEntity implements SmartBrainOwner<TriolobiteEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public TriolobiteEntity(EntityType<? extends AlienEntity> entityType, Level level) {
        super(entityType, level);
    }

    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes()
            .add(Attributes.ATTACK_DAMAGE, CommonMod.config.trilobiteConfigs.TRILOBITE_ATTACK)
            .add(Attributes.MAX_HEALTH, CommonMod.config.trilobiteConfigs.TRILOBITE_HEALTH)
            .add(Attributes.MOVEMENT_SPEED, CommonMod.config.trilobiteConfigs.TRILOBITE_SPEED);
    }
    ...
    @Override
    public List<? extends ExtendedSensor<TriolobiteEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<TriolobiteEntity>().setPredicate(
            ...
            new NearbyBlocksSensor<TriolobiteEntity>().setRadius(7)
                .setPredicate(
    ...
    @Override
    public BrainActivityGroup<TriolobiteEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<TriolobiteEntity> getIdleTasks() {
    ...
    @Override
    public BrainActivityGroup<TriolobiteEntity> getFightTasks() {
