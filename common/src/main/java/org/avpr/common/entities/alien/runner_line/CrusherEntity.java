...
public class CrusherEntity extends AlienEntity implements SmartBrainOwner<CrusherEntity> {
    ...
    @Override
    public List<? extends ExtendedSensor<CrusherEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<CrusherEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<CrusherEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<CrusherEntity> getFightTasks() {
