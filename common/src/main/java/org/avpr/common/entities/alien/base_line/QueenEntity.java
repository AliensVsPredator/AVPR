...
public class QueenEntity extends AlienEntity implements SmartBrainOwner<QueenEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public QueenEntity(EntityType<? extends AlienEntity> entityType, Level level) {
        super(entityType, level);
        SPAWN_HEIGHT_MAX = CommonMod.config.queenConfigs.QUEEN_MAX_SPAWN_Y;
    }
    ...
    @Override
    public List<? extends ExtendedSensor<QueenEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<QueenEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<QueenEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<QueenEntity> getFightTasks() {
