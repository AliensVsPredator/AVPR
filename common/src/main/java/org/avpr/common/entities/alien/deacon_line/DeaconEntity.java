...
public class DeaconEntity extends AlienEntity implements SmartBrainOwner<DeaconEntity> {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public DeaconEntity(EntityType<? extends AlienEntity> entityType, Level level) {
        super(entityType, level);
    }

    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes()
            .add(Attributes.ATTACK_DAMAGE, CommonMod.config.deaconConfigs.DEACON_ATTACK)
            .add(Attributes.MAX_HEALTH, CommonMod.config.deaconConfigs.DEACON_HEALTH)
            .add(Attributes.MOVEMENT_SPEED, CommonMod.config.deaconConfigs.DEACON_SPEED);
    }
    ...
    @Override
    public List<? extends ExtendedSensor<DeaconEntity>> getSensors() {
        return ObjectArrayList.of(
            new NearbyPlayersSensor<>(),
            new NearbyLivingEntitySensor<DeaconEntity>().setPredicate(
    ...
    @Override
    public BrainActivityGroup<DeaconEntity> getCoreTasks() {
    ...
    @Override
    public BrainActivityGroup<DeaconEntity> getIdleTasks() {
    ...
    @Override
    public BrainActivityGroup<DeaconEntity> getFightTasks() {
