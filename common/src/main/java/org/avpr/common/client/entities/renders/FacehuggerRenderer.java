...
public class FacehuggerRenderer extends GeoEntityRenderer<FacehuggerEntity>  {
    ...
    @Override
    public void render(FacehuggerEntity entity, float entityYaw, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight) {
