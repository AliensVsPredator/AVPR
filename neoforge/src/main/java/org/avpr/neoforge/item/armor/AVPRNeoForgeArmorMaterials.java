package org.avpr.neoforge.item.armor;
...
public class AVPRNeoForgeArmorMaterials {
     ...
     * }</pre>
     *
     * This example registers an armor material named "steel_armor" with specified protection levels, enchantability,
     * toughness, and knockback resistance, using an iron ingot as the repair material. See {@link ArmorMaterials} for
     * vanilla values
     * <p>
     ...
     *                            The keys are the armor types (HELMET, CHESTPLATE, LEGGINGS, BOOTS), and the values are
     *                            the respective protection levels.
     * @param enchantability      The enchantability value of the armor, affecting the likelihood of receiving better
     *                            enchantments.
     * @param toughness           The toughness value of the armor, which affects how much damage is reduced.
     * @param knockbackResistance The knockback resistance of the armor, which reduces the distance the player is
